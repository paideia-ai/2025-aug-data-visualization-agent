                        ...
                        return (
                          <div key={index} className="tool-status">
                            <div className="tool-header">
                              📊 {part.state === 'input-streaming' ? 'Preparing plot...' : 
                                  part.state === 'input-available' ? 'Drawing plot...' :
                                  part.state === 'output-available' ? 'Plot complete' : 'Processing...'}
                            </div>
                            ...
                            {part.state === 'output-available' && (
                              <div className={`tool-result ${result?.success ? 'success' : 'error'}`}>
                                {part.output || (result?.success ? '✅ ' + result.message : '❌ ' + (result?.error || 'Error'))}
                              </div>
                            )}
                          </div>
                        )
