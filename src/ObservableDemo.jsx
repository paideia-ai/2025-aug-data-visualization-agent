      ...
      if (statsTable) {
        statsTable.innerHTML = `
          ...
          statsSummary.objects().map((stats) => `
              ...
              <tr><td style="padding: 10px; border-bottom: 1px solid #eee;">Average Monthly Sales</td><td style="text-align: right; padding: 10px; border-bottom: 1px solid #eee;">$${
            Math.round(stats.avg_sales).toLocaleString()
          }</td></tr>
              ...
              <tr><td style="padding: 10px; border-bottom: 1px solid #eee;">Average Monthly Profit</td><td style="text-align: right; padding: 10px; border-bottom: 1px solid #eee;">$${
            Math.round(stats.avg_profit).toLocaleString()
          }</td></tr>
              <tr><td style="padding: 10px;">Profit Margin</td><td style="text-align: right; padding: 10px;">${
